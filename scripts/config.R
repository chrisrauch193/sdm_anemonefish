...
config <- list(
  ...
  pca_background_points_n = pca_background_points_n, background_points_n = background_points_n, thinning_method = thinning_method,  apply_coral_mask = apply_coral_mask, apply_depth_filter = apply_depth_filter,
